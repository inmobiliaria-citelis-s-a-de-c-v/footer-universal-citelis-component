...
class CitFooter {
  ...
  render() {
    ...
    let relativeFooter = hAsync("div", null, hAsync("footer", { class: "pie-pagina pie-position-rel" }, hAsync("div", { class: { 'clase-dark': this.theme === 'dark', 'clase-light': this.theme === 'light' } }, hAsync("span", { class: "textCopyright" }, "Copyright \u00A9 2023 citelis\u00AE. Todos los derechos reservados. ??")), hAsync("div", { class: "grupo-2" }, hAsync("img", { class: "poweredCitelis", src: poweredByCit }), hAsync("h6", { class: "texConoce" }, "Conoce m\u00E1s de citelis \u00AE y sus unidades de negocio"), hAsync("p", { class: "textAviso" }, hAsync("a", { class: "textAviso", href: 'https://www.citelis.com.mx/assets/docs/aviso-de-privacidad.pdf', target: "_blank" }, "Aviso de privacidad"))), renderHibrid));
