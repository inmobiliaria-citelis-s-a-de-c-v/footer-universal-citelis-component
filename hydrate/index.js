...
const citelisFooterCss = "@import url('https://fonts.googleapis.com/css2?family=Golos+Text:wght@700&display=swap');@import url('https://fonts.googleapis.com/css2?family=Tilt+Prism&display=swap');@import url('https://fonts.cdnfonts.com/css/metropolis-2');@import url('https://kit.fontawesome.com/52acfab3fb.css');@font-face{font-family:'Metropolis', sans-serif;font-display:swap;src:local(\"Metropolis\")}*{margin:0;padding:0;box-sizing:border-box;font-family:'Metropolis', sans-serif;}.poweredCitelis{width:141px}.textCopyright{font-family:'Metropolis', sans-serif;font-size:12px;letter-spacing:0px;opacity:1}.textAviso{font-family:'Metropolis', sans-serif;font-size:12px;letter-spacing:0px;color:#121F3E;opacity:1;margin-top:12px;text-decoration:none}.texConoce{font-family:'Metropolis-Medium', sans-serif;color:#121F3E;letter-spacing:0px;font-size:15px;opacity:1;text-align:center}.textHeader{font-family:'Metropolis-Medium', sans-serif;color:#121F3E;letter-spacing:0px;font-size:15px;opacity:1;text-align:left;padding:2px;margin-left:80px}.textNegocio{text-transform:uppercase;font-family:'Metropolis-Medium', sans-serif;color:#4E4E4E;letter-spacing:0px;padding:0px;font-size:11px;opacity:1;text-align:left;text-decoration:none;margin-top:5px}.accordion{cursor:pointer;transition:0.8s;background-color:#EFEFEF;color:#121F3E;height:42px;width:100%;border-top:1px solid #121F3E;opacity:1;padding:10px}.active,.accordion:hover{background-color:#EFEFEF;border-bottom:1px solid #121F3E}.accordion:after{content:'\\002B';color:#121F3E;font-weight:bold;float:right;margin-right:170px;margin-top:-20px;transition:1s}.active:after{content:\"\\2212\";transition:.8s}.panel{padding:0 18px;background-color:#EFEFEF;max-height:0;overflow:hidden;transition:max-height 0.4s ease-in-out}.headerAccordion{background-color:#EFEFEF;color:#121F3E;height:42px;width:100%;opacity:1;padding:10px}.active,.headerAccordion:hover{background-color:#EFEFEF}.headerAccordion:after{content:'\\002B';color:#EFEFEF;font-weight:bold;float:right;margin-right:170px}.imageSocialIcon{display:block;max-width:60px;max-height:37px;margin-top:5px}.textfrase{font-family:'Metropolis';font-size:19px}.rowgrid{height:26px;text-align:left;margin-left:56px}.textCitelis{font-family:'Metropolis';font-size:13px}.pie-pagina{width:100%;left:0;bottom:0;text-align:center}.pie-position-rel{position:relative}.pie-position-abs{position:absolute}.pie-position-fix{position:fixed}.collapsible{background-color:#EFEFEF;height:42px;width:100%;opacity:1;padding:10px}.content{padding:0 18px;overflow:visible;}.pie-pagina .grupo-1{width:100%;max-height:400px;margin:auto;display:grid;grid-template-columns:repeat(6, 1fr);grid-gap:2px;padding:15px 0px}.pie-pagina .grupo-2{background-color:#EFEFEF;padding:5px;height:85px;text-align:center;border-top:1px solid #121F3E;opacity:1}.pie-pagina .grupo-2 small{font-size:15px}.clase-light{background-color:#ffffff;padding:5px;height:28px;text-align:center;color:#121F3E !important}.pie-pagina .clase-dark{background-color:#000000;padding:5px;height:28px;text-align:center;color:#fdfdfd}input[type='checkbox']{display:none}.wrap-collabsible{margin:1.2rem 0}.lbl-toggle{display:block;font-weight:bold;font-family:monospace;font-size:1.2rem;text-transform:uppercase;text-align:center;padding:1rem;color:#DDD;background:#0069ff;cursor:pointer;border-radius:7px;transition:all 0.25s ease-out}.lbl-toggle:hover{color:#FFF}.lbl-toggle::before{content:' ';display:inline-block;border-top:5px solid transparent;border-bottom:5px solid transparent;border-left:5px solid currentColor;vertical-align:middle;margin-right:.7rem;transform:translateY(-2px);transition:transform .2s ease-out}.toggle:checked+.lbl-toggle::before{transform:rotate(90deg) translateX(-3px)}.collapsible-content{max-height:0px;overflow:hidden;transition:max-height .25s ease-in-out}.toggle:checked+.lbl-toggle+.collapsible-content{max-height:350px}.toggle:checked+.lbl-toggle{border-bottom-right-radius:0;border-bottom-left-radius:0}.collapsible-content .content-inner{background:rgba(0, 105, 255, .2);border-bottom:1px solid rgba(0, 105, 255, .45);border-bottom-left-radius:7px;border-bottom-right-radius:7px;padding:.5rem 1rem}.collapsible-content p{margin-bottom:0}@media screen and (max-width:1200px){.pie-pagina .grupo-1{width:100%;grid-template-columns:repeat(4, 1fr);grid-gap:6px;padding:35px 0px}.rowgrid{height:30px;text-align:left;margin-left:20px}}@media screen and (max-width:900px){.pie-pagina .grupo-1{width:100%;grid-template-columns:repeat(3, 1fr);grid-gap:6px;padding:35px 0px}.rowgrid{height:30px;text-align:left;margin-left:20px}}@media screen and (max-width:600px){.pie-pagina .grupo-1{width:100%;grid-template-columns:repeat(2, 1fr);grid-gap:6px;padding:35px 0px}.rowgrid{height:30px;text-align:left;margin-left:20px}.textHeader{text-align:left;padding:2px;margin-left:35px}.accordion:after{float:right;margin-right:60px;margin-top:-20px;transition:1s}}@media screen and (max-width:440px){.pie-pagina .grupo-1{width:100%;grid-template-columns:repeat(1, 1fr);grid-gap:6px;padding:35px 0px}.rowgrid{height:40px;text-align:left;margin-left:10px}.textHeader{text-align:left;padding:2px;margin-left:15px}.accordion:after{float:right;margin-right:60px;margin-top:-18px;transition:1s}.pie-pagina .grupo-2{height:105px}.poweredCitelis{margin-top:13px}.textCopyright{font-size:10px}}";
