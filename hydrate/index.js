...
/*!
 Stencil Mock Doc v3.1.0 | MIT Licensed | https://stenciljs.com
 */
...
const NAMESPACE = 'footer-universal-citelis-component';
const BUILD = /* footer-universal-citelis-component */ { allRenderFn: true, appendChildSlotFix: false, asyncLoading: true, attachStyles: true, cloneNodeFix: false, cmpDidLoad: true, cmpDidRender: false, cmpDidUnload: false, cmpDidUpdate: false, cmpShouldUpdate: false, cmpWillLoad: false, cmpWillRender: false, cmpWillUpdate: false, connectedCallback: false, constructableCSS: false, cssAnnotations: true, cssVarShim: false, devTools: false, disconnectedCallback: false, dynamicImportShim: false, element: false, event: false, hasRenderFn: true, hostListener: false, hostListenerTarget: false, hostListenerTargetBody: false, hostListenerTargetDocument: false, hostListenerTargetParent: false, hostListenerTargetWindow: false, hotModuleReplacement: false, hydrateClientSide: true, hydrateServerSide: true, hydratedAttribute: false, hydratedClass: true, isDebug: false, isDev: false, isTesting: false, lazyLoad: true, lifecycle: true, lifecycleDOMEvents: false, member: true, method: true, mode: false, observeAttribute: true, profile: false, prop: true, propBoolean: true, propMutable: false, propNumber: false, propString: true, reflect: false, safari10: false, scoped: false, scriptDataOpts: false, shadowDelegatesFocus: false, shadowDom: true, shadowDomShim: true, slot: false, slotChildNodesFix: false, slotRelocation: true, state: true, style: true, svg: false, taskQueue: true, updatable: true, vdomAttribute: true, vdomClass: true, vdomFunctional: false, vdomKey: true, vdomListener: false, vdomPropOrAttr: true, vdomRef: false, vdomRender: true, vdomStyle: false, vdomText: true, vdomXlink: false, watchCallback: false };
...
const citelisFooterCss = "@import url('https://fonts.googleapis.com/css2?family=Golos+Text:wght@700&display=swap');@import url('https://fonts.googleapis.com/css2?family=Tilt+Prism&display=swap');@import url('https://fonts.cdnfonts.com/css/metropolis-2');@import url('https://kit.fontawesome.com/52acfab3fb.css');@font-face{font-family:'Metropolis', sans-serif;font-display:swap;src:local(\"Metropolis\")}/*!@**/*.sc-citelis-footer{margin:0;padding:0;box-sizing:border-box;font-family:'Metropolis', sans-serif}/*!@.poweredCitelis*/.poweredCitelis.sc-citelis-footer{width:141px}/*!@.textCopyright*/.textCopyright.sc-citelis-footer{font-family:'Metropolis', sans-serif;font-size:12px;letter-spacing:0px;opacity:1}/*!@.textAviso*/.textAviso.sc-citelis-footer{font-family:'Metropolis', sans-serif;font-size:12px;letter-spacing:0px;color:#121F3E;opacity:1;margin-top:12px;text-decoration:none}/*!@.texConoce*/.texConoce.sc-citelis-footer{font-family:'Metropolis-Medium', sans-serif;color:#121F3E;letter-spacing:0px;font-size:15px;opacity:1;text-align:center}/*!@.textHeader*/.textHeader.sc-citelis-footer{font-family:'Metropolis-Medium', sans-serif;color:#121F3E;letter-spacing:0px;font-size:15px;opacity:1;text-align:left;padding:2px;margin-left:80px}/*!@.textNegocio*/.textNegocio.sc-citelis-footer{text-transform:uppercase;font-family:'Metropolis-Medium', sans-serif;color:#4E4E4E;letter-spacing:0px;padding:0px;font-size:11px;opacity:1;text-align:left;text-decoration:none;margin-top:5px}/*!@.accordion*/.accordion.sc-citelis-footer{cursor:pointer;transition:0.8s;background-color:#EFEFEF;color:#121F3E;height:42px;width:100%;border-top:1px solid #121F3E;opacity:1;padding:10px}/*!@.active, .accordion:hover*/.active.sc-citelis-footer,.accordion.sc-citelis-footer:hover{background-color:#EFEFEF;border-bottom:1px solid #121F3E}/*!@.accordion:after*/.accordion.sc-citelis-footer:after{content:'\\002B';color:#121F3E;font-weight:bold;float:right;margin-right:170px;margin-top:-20px;transition:1s}/*!@.active:after*/.active.sc-citelis-footer:after{content:\"\\2212\";transition:.8s}/*!@.panel*/.panel.sc-citelis-footer{padding:0 18px;background-color:#EFEFEF;max-height:0;overflow:hidden;transition:max-height 0.4s ease-in-out}/*!@.headerAccordion*/.headerAccordion.sc-citelis-footer{background-color:#EFEFEF;color:#121F3E;height:42px;width:100%;opacity:1;padding:10px}/*!@.active, .headerAccordion:hover*/.active.sc-citelis-footer,.headerAccordion.sc-citelis-footer:hover{background-color:#EFEFEF}/*!@.headerAccordion:after*/.headerAccordion.sc-citelis-footer:after{content:'\\002B';color:#EFEFEF;font-weight:bold;float:right;margin-right:170px}/*!@.imageSocialIcon*/.imageSocialIcon.sc-citelis-footer{display:block;max-width:60px;max-height:37px;margin-top:5px}/*!@.textfrase*/.textfrase.sc-citelis-footer{font-family:'Metropolis';font-size:19px}/*!@.rowgrid*/.rowgrid.sc-citelis-footer{height:26px;text-align:left;margin-left:56px}/*!@.textCitelis*/.textCitelis.sc-citelis-footer{font-family:'Metropolis';font-size:13px}/*!@.pie-pagina*/.pie-pagina.sc-citelis-footer{width:100%;left:0;bottom:0;text-align:center}/*!@.pie-position-rel*/.pie-position-rel.sc-citelis-footer{position:relative}/*!@.pie-position-abs*/.pie-position-abs.sc-citelis-footer{position:absolute}/*!@.pie-position-fix*/.pie-position-fix.sc-citelis-footer{position:fixed}/*!@.collapsible*/.collapsible.sc-citelis-footer{background-color:#EFEFEF;height:42px;width:100%;opacity:1;padding:10px}/*!@.content*/.content.sc-citelis-footer{padding:0 18px;overflow:visible}/*!@.pie-pagina .grupo-1*/.pie-pagina.sc-citelis-footer .grupo-1.sc-citelis-footer{width:100%;max-height:400px;margin:auto;display:grid;grid-template-columns:repeat(6, 1fr);grid-gap:2px;padding:15px 0px}/*!@.pie-pagina .grupo-2*/.pie-pagina.sc-citelis-footer .grupo-2.sc-citelis-footer{background-color:#EFEFEF;padding:5px;height:85px;text-align:center;border-top:1px solid #121F3E;opacity:1}/*!@.pie-pagina .grupo-2 small*/.pie-pagina.sc-citelis-footer .grupo-2.sc-citelis-footer small.sc-citelis-footer{font-size:15px}/*!@.clase-light*/.clase-light.sc-citelis-footer{background-color:#ffffff;padding:5px;height:28px;text-align:center;color:#121F3E !important}/*!@.pie-pagina .clase-dark*/.pie-pagina.sc-citelis-footer .clase-dark.sc-citelis-footer{background-color:#000000;padding:5px;height:28px;text-align:center;color:#fdfdfd}/*!@input[type='checkbox']*/input[type='checkbox'].sc-citelis-footer{display:none}/*!@.wrap-collabsible*/.wrap-collabsible.sc-citelis-footer{margin:1.2rem 0}/*!@.lbl-toggle*/.lbl-toggle.sc-citelis-footer{display:block;font-weight:bold;font-family:monospace;font-size:1.2rem;text-transform:uppercase;text-align:center;padding:1rem;color:#DDD;background:#0069ff;cursor:pointer;border-radius:7px;transition:all 0.25s ease-out}/*!@.lbl-toggle:hover*/.lbl-toggle.sc-citelis-footer:hover{color:#FFF}/*!@.lbl-toggle::before*/.lbl-toggle.sc-citelis-footer::before{content:' ';display:inline-block;border-top:5px solid transparent;border-bottom:5px solid transparent;border-left:5px solid currentColor;vertical-align:middle;margin-right:.7rem;transform:translateY(-2px);transition:transform .2s ease-out}/*!@.toggle:checked+.lbl-toggle::before*/.toggle.sc-citelis-footer:checked+.lbl-toggle.sc-citelis-footer::before{transform:rotate(90deg) translateX(-3px)}/*!@.collapsible-content*/.collapsible-content.sc-citelis-footer{max-height:0px;overflow:hidden;transition:max-height .25s ease-in-out}/*!@.toggle:checked + .lbl-toggle + .collapsible-content*/.toggle.sc-citelis-footer:checked+.lbl-toggle.sc-citelis-footer+.collapsible-content.sc-citelis-footer{max-height:350px}/*!@.toggle:checked+.lbl-toggle*/.toggle.sc-citelis-footer:checked+.lbl-toggle.sc-citelis-footer{border-bottom-right-radius:0;border-bottom-left-radius:0}/*!@.collapsible-content .content-inner*/.collapsible-content.sc-citelis-footer .content-inner.sc-citelis-footer{background:rgba(0, 105, 255, .2);border-bottom:1px solid rgba(0, 105, 255, .45);border-bottom-left-radius:7px;border-bottom-right-radius:7px;padding:.5rem 1rem}/*!@.collapsible-content p*/.collapsible-content.sc-citelis-footer p.sc-citelis-footer{margin-bottom:0}@media screen and (max-width:1200px){/*!@.pie-pagina .grupo-1*/.pie-pagina.sc-citelis-footer .grupo-1.sc-citelis-footer{width:100%;grid-template-columns:repeat(4, 1fr);grid-gap:6px;padding:35px 0px}/*!@.rowgrid*/.rowgrid.sc-citelis-footer{height:30px;text-align:left;margin-left:20px}}@media screen and (max-width:900px){/*!@.pie-pagina .grupo-1*/.pie-pagina.sc-citelis-footer .grupo-1.sc-citelis-footer{width:100%;grid-template-columns:repeat(3, 1fr);grid-gap:6px;padding:35px 0px}/*!@.rowgrid*/.rowgrid.sc-citelis-footer{height:30px;text-align:left;margin-left:20px}}@media screen and (max-width:600px){/*!@.pie-pagina .grupo-1*/.pie-pagina.sc-citelis-footer .grupo-1.sc-citelis-footer{width:100%;grid-template-columns:repeat(2, 1fr);grid-gap:6px;padding:35px 0px}/*!@.rowgrid*/.rowgrid.sc-citelis-footer{height:30px;text-align:left;margin-left:20px}/*!@.textHeader*/.textHeader.sc-citelis-footer{text-align:left;padding:2px;margin-left:35px}/*!@.accordion:after*/.accordion.sc-citelis-footer:after{float:right;margin-right:60px;margin-top:-20px;transition:1s}}@media screen and (max-width:440px){/*!@.pie-pagina .grupo-1*/.pie-pagina.sc-citelis-footer .grupo-1.sc-citelis-footer{width:100%;grid-template-columns:repeat(1, 1fr);grid-gap:6px;padding:35px 0px}/*!@.rowgrid*/.rowgrid.sc-citelis-footer{height:40px;text-align:left;margin-left:10px}/*!@.textHeader*/.textHeader.sc-citelis-footer{text-align:left;padding:2px;margin-left:15px}/*!@.accordion:after*/.accordion.sc-citelis-footer:after{float:right;margin-right:60px;margin-top:-18px;transition:1s}/*!@.pie-pagina .grupo-2*/.pie-pagina.sc-citelis-footer .grupo-2.sc-citelis-footer{height:105px}/*!@.poweredCitelis*/.poweredCitelis.sc-citelis-footer{margin-top:13px}/*!@.textCopyright*/.textCopyright.sc-citelis-footer{font-size:10px}}";
...
class CitFooter {
  ...
  render() {
    ...
    Object.entries(citelis).forEach(([key, value], index) => {
      renderHibrid2 = [];
      renderHibrid3 = [];
      renderHibrid.push(hAsync("button", { class: "accordion", key: index }, " ", hAsync("h3", { class: "textHeader" }, key), "  "));
      //llenando rowgrids de marcas
      Object.entries(value).forEach(([key2, value2], index2) => {
        //row gris de 6 push
        renderHibrid2.push(hAsync("div", { class: "rowgrid" }, hAsync("a", { class: "textNegocio", href: value2.url, key: index2, target: "_blank" }, key2)));
      });
      renderHibrid3.push(hAsync("div", { class: "content" }, hAsync("div", { class: "grupo-1" }, renderHibrid2)));
      renderHibrid.push(hAsync("div", { class: "panel" }, renderHibrid3));
    });
    let absoluteFooter = hAsync("div", null, hAsync("footer", { class: "pie-pagina pie-position-abs" }, hAsync("div", { class: { 'clase-dark': this.theme === 'dark', 'clase-light': this.theme === 'light' } }, hAsync("span", { part: 'textCopyright', class: "textCopyright" }, "Copyright \u00A9 2023 citelis\u00AE. Todos los derechos reservados. ")), hAsync("div", { class: "grupo-2" }, hAsync("img", { class: "poweredCitelis", src: poweredByCit }), hAsync("h6", { class: "texConoce" }, "Conoce m\u00E1s de citelis \u00AE y sus unidades de negocio"), hAsync("p", { class: "textAviso" }, hAsync("a", { class: "textAviso", href: 'https://www.citelis.com.mx/assets/docs/aviso-de-privacidad.pdf', target: "_blank" }, "Aviso de privacidad"))), renderHibrid));
    let fixedFooter = hAsync("div", null, hAsync("footer", { class: "pie-pagina pie-position-fix" }, hAsync("div", { class: { 'clase-dark': this.theme === 'dark', 'clase-light': this.theme === 'light' } }, hAsync("span", { class: "textCopyright" }, "Copyright \u00A9 2023 citelis\u00AE. Todos los derechos reservados. ")), hAsync("div", { class: "grupo-2" }, hAsync("img", { class: "poweredCitelis", src: poweredByCit }), hAsync("h6", { class: "texConoce" }, "Conoce m\u00E1s de citelis \u00AE y sus unidades de negocio"), hAsync("p", { class: "textAviso" }, hAsync("a", { class: "textAviso", href: 'https://www.citelis.com.mx/assets/docs/aviso-de-privacidad.pdf', target: "_blank" }, "Aviso de privacidad"))), renderHibrid));
    let relativeFooter = hAsync("div", null, hAsync("footer", { class: "pie-pagina pie-position-rel" }, hAsync("div", { class: { 'clase-dark': this.theme === 'dark', 'clase-light': this.theme === 'light' } }, hAsync("span", { class: "textCopyright" }, "Copyright \u00A9 2023 citelis\u00AE. Todos los derechos reservados.  PROOO")), hAsync("div", { class: "grupo-2" }, hAsync("img", { class: "poweredCitelis", src: poweredByCit }), hAsync("h6", { class: "texConoce" }, "Conoce m\u00E1s de citelis \u00AE y sus unidades de negocio"), hAsync("p", { class: "textAviso" }, hAsync("a", { class: "textAviso", href: 'https://www.citelis.com.mx/assets/docs/aviso-de-privacidad.pdf', target: "_blank" }, "Aviso de privacidad"))), renderHibrid));
  ...
  async fetchPokemon(name) {
    ...
    if (response.ok) {
      const pokemon = data === null || data === void 0 ? void 0 : data.pokemon;
      if (pokemon) {
      ...
      const error = new Error((_a = errors === null || errors === void 0 ? void 0 : errors.map(e => e.message).join('\n')) !== null && _a !== void 0 ? _a : 'unknown');
      return Promise.reject(error);
    }
  }
  static get assetsDirs() { return ["assets"]; }
  get element() { return getElement(this); }
  static get style() { return citelisFooterCss; }
  static get cmpMeta() { return {
    "$flags$": 9,
    "$tagName$": "citelis-footer",
    "$members$": {
      "position": [1],
      "theme": [1],
      "image": [1],
...
class MyComponent {
  ...
  render() {
    ...
    return hAsync("div", null, "Hello, World! I'm ", this.getText(), hAsync("img", { src: imageSrc }));
  }
  static get assetsDirs() { return ["assets"]; }
